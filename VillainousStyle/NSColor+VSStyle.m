...
#import <VillainousStyle/NSColor+VSStyle.h>
...
+ (VSColor*)colorWithHue:(CGFloat)h saturation:(CGFloat)s value:(CGFloat)v alpha:(CGFloat)a {
	...
	return [VSColor colorWithRed:r green:g blue:b alpha:a];
}
...
- (VSColor*)copyWithAlpha:(CGFloat)newAlpha {
	...
	return [[VSColor colorWithRed:r green:g blue:b alpha:newAlpha] retain];
}
